			...
			<section class="section-home home-1">
				<section class="main-slider">
					<div class="slider-pro full-width-slider" id="main-slider" data-width="100%" data-height="570" data-fade="true" data-buttons="true" data-wait-for-layers="true" data-thumbnail-pointer="false" data-touch-swipe="false" data-autoplay="true" data-auto-scale-layers="true" data-visible-size="100%" data-force-size="fullWidth" data-autoplay-delay="5000" >
						<div class="sp-slides">
							<div class="sp-slide">
								<img class="sp-image" src="images/home_1.jpg"
									data-src="images/home_1.jpg"
									data-retina="images/home_1.jpg" alt="slide1" />
								...
								<div class="sp-layer slide-tex-1"
									...
									<span>手机耳机精品推送<br><span class="border-line">甩卖</span></span>
								</div>
								...
								<div class="sp-layer"
									...
									<a href="F_category-grid-digital.jsp"><button class="btn btn-primary-color1 btn-sm" >现在就买</button></a>
								</div>
							</div>

							<div class="sp-slide">
								<img class="sp-image" src="images/home_2.jpg"
									data-src="images/home_2.jpg"
									data-retina="images/home_2.jpg" alt="slide2" />
								...
								<div class="sp-layer text-highlight"
									...
									data-show-transition="left" data-hide-transition="up" data-show-delay="800">
									<span class="highlight-primary">实体店里你需要100块，交易专卖只需要50块</span>
								</div>
								<div class="sp-layer"
									data-horizontal="15%" data-vertical="63.4%"
									data-show-transition="left" data-hide-transition="up" data-show-delay="1000">
									<a href="F_category-grid-clothes.jsp"><button class="btn btn-primary-color1 btn-sm" >现在就买</button></a>
								</div>
							</div>

							<div class="sp-slide">
								<img class="sp-image" src="images/home_3.jpg"
									data-src="images/home_3.jpg"
									data-retina="images/home_3.jpg" alt="slide3" />
						...
						<div class="row">
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
								<a href="#" class="wow fadeInLeft">
									<img src="images/购物车.jpg_wh300_副本.jpg" class="img-responsive center-block" alt="/">
								</a>
							</div>
							<div class="prom-right col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<div class="row wow fadeInRight">
									<div class="col-sm-12">
										<a href="#">
											<img src="images/1-1F50P11613c5_副本.jpg" class="img-responsive center-block" alt="/">
										</a>
									</div>
									<div class="col-sm-12">
										<a href="#">
							...
							<div class="col-sm-12">
								<ul class="nav nav-tabs" role="tablist">
									<li role="presentation" class="active">
										<a class="heading-line-long" href="home-1.html#bybrand" aria-controls="bybrand" role="tab" data-toggle="tab">产品推荐榜单</a>
									</li>
								</ul>
									...
									<div role="tabpanel" class="tab-pane active" id="bybrand">
												...
												<div class="b-brand-filters">
													<div>
														<ul class="tags-buttons list-inline by-brands-buttons">
															<li>
																<button data-filter="*" class="btn btn-tag active">所有产品</button>
															</li>
															<li>
																<button data-filter=".digital" class="btn btn-tag">闲置数码</button>
															</li>
															<li>
																<button data-filter=".clothes" class="btn btn-tag">鞋服配饰</button>
															</li>
															<li>
																<button data-filter=".app" class="btn btn-tag">影音家电</button>
															</li>
															<li>
																<button data-filter=".book" class="btn btn-tag">二手书籍</button>
															</li>
														</ul>
													</div>
												</div>
										...
										<div class="row">
											...
											%>
									        	...
									        	<div class="<%=list.get(i).get("Category") %> related-item col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="b-item-card">
														<div class="image">
															<a href="<%=list.get(i).get("Url") %>" data-gal="prettyPhoto" title="<%=list.get(i).get("Name") %>">
																<img src="<%=list.get(i).get("Url") %>" class="img-responsive center-block" alt="/">
															</a>
														...
														<div class="card-info">
															...
															<div class="add-buttons">
																<a href="../collect_add.so?id=<%=list.get(i).get("ID") %>"><button  class="btn btn-add btn-add-wish"><i class="fa fa-heart-o" ></i></button></a>
															    <a href="../car_add.so?id=<%=list.get(i).get("ID") %>"><button type="button" class="btn btn-add btn-add-cart"><i class="fa fa-shopping-cart"></i></button></a>                            
														    </div>
														</div>
													</div>
												</div>
				...
				<div class="b-home-blog">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="heading-line-long">实时资讯</h3>
							</div>						
							<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
								<div class="row">							
									<div class="b-posts-holder clearfix">
									   <%                        
											String sql2="select * from news limit 3";
										...
										<div class="b-post-preview col-xs-12 col-sm-4 col-md-4 col-lg-4 clearfix wow fadeInLeft">
											<div class="post-image">
												<div class="post-img-holder">
													<div>
														<img src="<%=list2.get(i).get("Photo") %>" class="img-responsive center-block" alt="/">
														<div class="image-add">
															<a href="<%=list2.get(i).get("Url") %>" class="btn btn-default-color1 btn-sm" target="blank">查阅 详情</a>
														</div>
													</div>
												</div>
												<div class="post-data">
													<span>05 dec 2017</span>
												</div>
											</div>
											<div class="post-caption">
												<div class="post-author">
													<span><i class="fa fa-comment-o"></i>作者：<%=list2.get(i).get("Author") %></span>
												</div>
												<div class="caption">
													<h5 class="heading-line"><%=list2.get(i).get("Title") %></h5>
													<div class="post-description">
														<p>
														 <%=list2.get(i).get("Content") %>
														</p>
													</div>
												</div>
												<span>发布时期：<%=list2.get(i).get("AddTime") %></span>
											</div>
										</div>	
										<%} %>																		
									</div>
							...
							<div class="col-sm-12">
								<div class="clearfix">
									<div class="b-copy pull-left wow fadeInLeft">
										<p>
											Copyright © 2017 <a href="#">苏子子二手交易网</a> All Rights Reserved.
										</p>
									</div>
								</div>
							</div>
