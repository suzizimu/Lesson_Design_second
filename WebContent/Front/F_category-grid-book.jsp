			...
			<section class="section-category">
				<div class="b-page-header">
					<div class="container">
						<div class="row">
							<div class="col-sm-12 clearfix">
								<h3 class="page-title pull-left">二手书籍</h3>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="b-offers wow fadeInUp">
								<a href="#">
									<img src="images/1-1F501112445327_副本_副本.jpg" class="img-responsive center-block" alt="/">
								</a>
							</div>
							...
							<div class="b-grid">
								<div class="row">
									<%                        
										String sql="select * from goods where goodstype='书籍'";
