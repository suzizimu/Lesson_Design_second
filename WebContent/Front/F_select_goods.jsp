			...
			<section class="section-category">
				<div class="b-page-header">
					<div class="container">
						<div class="row">
							<div class="col-sm-12 clearfix">
								<h3 class="page-title pull-left">查询商品</h3>
								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
										<div class="b-item-card">
											<div class="image">
												<a href="${goods.url}" data-gal="prettyPhoto" title="${goods.name}">
													<img src="${goods.url}" class="img-responsive center-block" alt="${goods.name}">
													<div class="image-add-mod">
														<div class="add-description">
																<div>
																	<span>${goods.goodsType}</span>
																	<br>																	
																	<span>￥${goods.priceAgo}</span>
																	<br>
																	<span>九成新</span>
																	<br>
																	...
																	<a href="${goods.url}" data-gal="prettyPhoto" title="${goods.name}" class="btn btn-lightbox btn-default-color1 btn-sm">
											...
											<div class="card-info">
												<div class="caption">
													<div class="name-item">
														<a class="product-name" href="../goods_detail.so?id=${goods.ID}">${goods.name}</a>
														<div class="rating">
															<span class="star"><i class="fa fa-star"></i></span>
															<span class="star"><i class="fa fa-star"></i></span>
															<span class="star"><i class="fa fa-star"></i></span>
													...
													<div class="product-description">
														<p>${goods.introduce}，真的用着非常好啊哈哈哈，恩恩额恩额n，哈哈哈哈哈哈哈，还是很不凑的选择呢，真的诶哦
														</p>													
													</div>
												</div>
												<div class="add-buttons">
													<button type="button" class="btn btn-add btn-add-compare"><i class="fa fa-refresh"></i></button>
													<a href="../collect_add.so?id=${goods.ID}"><button type="button" class="btn btn-add btn-add-wish"><i class="fa fa-heart-o"></i></button></a>
													<a href="../car_add.so?id=${goods.ID}"><button type="button" class="btn btn-add btn-add-cart"><i class="fa fa-shopping-cart"></i></button></a> <%--第一个购物车按钮 --%>
													<div class="cart-add-buttons">
														<a href="../car_add.so?id=${goods.ID}"><button type="button" class="btn btn-cart-color1"><i class="fa fa-shopping-cart"></i>添加到购物车</button></a><%--第二个购物车按钮 --%>
													</div>
												</div>
											</div>
										</div>
