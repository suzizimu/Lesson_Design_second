			...
			<section class="section-mywishlist">
				<div class="b-page-header">
					<div class="container">
						<div class="row">
							<div class="col-sm-12 clearfix">
								<h3 class="page-title pull-left">举报反馈</h3>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 wow fadeInLeft">
							...
							<div id="success"></div>
							<form  id="contactForm" class="b-form"  action="/Lesson_Design_second/report_add.so" method="post">
								<div class="form-group">
									...
									<div class="row">
										<div class="col-sm-12">
											<input name="memberName" class="form-control" id="form-first-name" placeholder="会员名称" readonly="readonly" value="<%=session.getAttribute("member_name")%>">
										</div>
										<div class="col-sm-6">
											<input name="goodsID" class="form-control" id="form-last-name" placeholder="商品ID" readonly="readonly" value="${report.goodsID}">
										</div>
										<div class="col-sm-6">
											<input name="goodsName" class="form-control" id="form-last-name" placeholder="商品名称" readonly="readonly" value="${report.goodsName}">
										</div>
										<div class="col-sm-12">
											<input name="tel" class="form-control" id="form-email" placeholder="会员联系方式" value="${report.tel}">	
										</div>					
										<div class="col-sm-12">
											<textarea  name="introduce" id="form-comment" class="form-control" rows="6" placeholder="举报内容"></textarea>
										</div>
										    <%	
                                        Date date =new Date();
	 	                                ...
	 	                                //sdf.format(date);
	                                        %>
										<div class="col-sm-12">
											<input name="date" class="form-control" id="form-subject" placeholder="举报日期" value="<%=sdf.format(date)%>" readonly="readonly">
										</div>
										<div class="col-sm-12">
