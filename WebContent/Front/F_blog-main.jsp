			...
			<section class="section-blog-main">
				<div class="b-page-header">
					<div class="container">
						<div class="row">
							<div class="col-sm-12 clearfix">
								<h3 class="page-title pull-left">实时 资讯</h3>
								...
								<div class="b-post-preview clearfix">
									<div class="post-image pull-left ">
										<div class="post-img-holder">
											<div>
												<img src="<%=list2.get(i).get("Photo") %>" class="img-responsive center-block" alt="/" target="blank">
												<div class="image-add">
													<a href="<%=list2.get(i).get("Url") %>" class="btn btn-default-color1 btn-sm">查阅 详情</a>
												</div>
											</div>
										</div>
										<div class="post-data">
									...
									<div class="post-caption pull-left">
										<div class="post-author">
											<span><i class="fa fa-user"></i>作者：<%=list2.get(i).get("Author") %></span>
										</div>
										<div class="caption">
