			...
			<section class="section-mywishlist">
				<div class="b-page-header">
					<div class="container">
						<div class="row">
							<div class="col-sm-12 clearfix">
								<h3 class="page-title pull-left">个人 收藏</h3>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-right">
							<a href="../collect_deleteAll.so?"><button class="btn btn-default-color1 btn-sm btn-clear" type="button">全部清空</button></a>
						</div>
						<div class="col-sm-12 mywishlist-container">
							<div class="row">
								<%                        
											String sql="select * from collect where collector='"+session.getAttribute("member_name")+"' limit 8";
								...
								<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
									<div class="b-item-card wow fadeInUp">
										<div class="image">
											...
											<div class="image-add">
												<a href="../collect_delete.so?id=<%=list.get(i).get("ID") %>"><button class="btn btn-default-color1 btn-sm" type="button">从表中删除</button></a>
											</div>
										</div>
										<div class="card-info">
											<div class="caption">
												<p class="name-item">
													<a class="product-name" href="../goods_detail.so?id=<%=list.get(i).get("GoodsID") %>"><%=list.get(i).get("Name") %></a>
												</p>
												<span class="product-price">￥<%=list.get(i).get("PriceNow") %></span>
											</div>
											<div class="add-buttons">
												<a href="../collect_delete.so?id=<%=list.get(i).get("ID") %>"><button type="button" class="btn btn-add btn-add-remove"><i class="fa fa-trash"></i></button></a>
						...
						<div class="col-sm-12 text-center">
							<nav>
								<ul class="pagination pagination-mod pagination-color1 wow fadeInUp">
