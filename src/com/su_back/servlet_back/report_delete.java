...
/**
 * Servlet implementation class report_delete
 */
@WebServlet("/report_delete.do")
public class report_delete extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		log.setDs("在"+sdf.format(date)+"进行了删除反馈举报操作");
		log.setName(name);
		log.setType("删除");
        ...
        try {       	
			rs.delete_report(Integer.parseInt(id));
			rs.log(log);
